...
//        }
//        isInitialized = true;
//        eventEntityGenerator.generateEventsInitScript(
//                "fileName",
//                1L,
//                "testIntegrationId1",
//                10L,
...
//        log.info("Result size=" + instanceFlowSummaries.getContent().size());
////        log.info("Instances=" +
////                 instanceFlowSummaries.getContent().stream()
////                         .map(InstanceFlowSummaryProjection::toString)
////                         .collect(joining(",\r\n", "\r\n[", "\r\n]"))
////        );
//    }
//

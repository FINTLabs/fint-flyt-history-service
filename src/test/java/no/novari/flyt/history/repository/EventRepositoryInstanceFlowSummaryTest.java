...
import no.novari.flyt.history.repository.utils.instanceflowsummary.EventEntitiesAndExpectedSummary;
import no.novari.flyt.history.repository.utils.instanceflowsummary.FilterPropertyTestCaseConfiguration;
import no.novari.flyt.history.repository.utils.instanceflowsummary.FilterPropertyTestCases;
...
import static no.novari.flyt.history.repository.utils.instanceflowsummary.Dataset.ALL_EVENTS_AND_EXPECTED_SUMMARIES;
import static no.novari.flyt.history.repository.utils.instanceflowsummary.Dataset.ALL_STATUS_EVENT_NAMES;
import static no.novari.flyt.history.repository.utils.instanceflowsummary.Dataset.ALL_STORAGE_STATUS_EVENT_NAMES;
import static no.novari.flyt.history.repository.utils.instanceflowsummary.Dataset.DESTINATION_INSTANCE_ID_1;
import static no.novari.flyt.history.repository.utils.instanceflowsummary.Dataset.DESTINATION_INSTANCE_ID_2;
import static no.novari.flyt.history.repository.utils.instanceflowsummary.Dataset.SA1_1_1;
import static no.novari.flyt.history.repository.utils.instanceflowsummary.Dataset.SA1_1_2;
import static no.novari.flyt.history.repository.utils.instanceflowsummary.Dataset.SA2_2_1;
import static no.novari.flyt.history.repository.utils.instanceflowsummary.Dataset.SA2_3_3;
import static no.novari.flyt.history.repository.utils.instanceflowsummary.Dataset.SA3_4_4;
import static no.novari.flyt.history.repository.utils.instanceflowsummary.Dataset.SA_INSTANCE_ID_1;
import static no.novari.flyt.history.repository.utils.instanceflowsummary.Dataset.SA_INSTANCE_ID_4;
import static no.novari.flyt.history.repository.utils.instanceflowsummary.Dataset.SA_INTEGRATION_ID_1;
import static no.novari.flyt.history.repository.utils.instanceflowsummary.Dataset.SA_INTEGRATION_ID_2;
import static no.novari.flyt.history.repository.utils.instanceflowsummary.Dataset.SA_INTEGRATION_ID_3;
import static no.novari.flyt.history.repository.utils.instanceflowsummary.Dataset.STATUS_EVENT_NAME_1;
import static no.novari.flyt.history.repository.utils.instanceflowsummary.Dataset.STATUS_EVENT_NAME_3;
import static no.novari.flyt.history.repository.utils.instanceflowsummary.Dataset.STATUS_EVENT_NAME_5;
import static no.novari.flyt.history.repository.utils.instanceflowsummary.Dataset.STORAGE_STATUS_EVENT_NAME_1;
import static no.novari.flyt.history.repository.utils.instanceflowsummary.Dataset.STORAGE_STATUS_EVENT_NAME_2;
import static no.novari.flyt.history.repository.utils.instanceflowsummary.Dataset.UNUSED_LONG_ID;
import static no.novari.flyt.history.repository.utils.instanceflowsummary.Dataset.UNUSED_STRING_ID;
import static no.novari.flyt.history.repository.utils.instanceflowsummary.ParameterizedInstanceFlowTestCaseGenerator.createFilterPropertyTestCases;
